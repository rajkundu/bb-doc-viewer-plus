...
waitForElement('div.toolbar-end-container').then((parent) => {
    if (window.self !== window.top){
        ...
        btnSpan.innerHTML = `
        <a href="" target="bbdoc_${(new Date()).getTime()}"><button class="MuiButtonBaseroot-0-2-10 MuiIconButtonroot-0-2-1" tabindex="0" type="button" aria-label="Open in New Tab" title="Open in New Tab"><span class="MuiIconButtonlabel-0-2-9"><svg focusable="false" aria-hidden="true" role="presentation" viewBox="0 0 512 512" margin="5px" style="width: 1rem; height: 1rem; vertical-align: middle;">
